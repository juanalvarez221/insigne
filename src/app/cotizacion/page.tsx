  ...
  return (
    <QuoteShell>
      <section className="relative mb-8">
        <div className="pointer-events-none absolute -left-10 -top-10 h-40 w-40 rounded-full bg-amber-700/15 blur-[60px]" />
      ...
      <section className="mb-8">
        <div className="glass-card rounded-2xl p-5">
          <div className="mb-4 flex items-center gap-3">
            <div className="flex h-6 w-6 items-center justify-center rounded-full border border-amber-600/30 bg-amber-700/10">
          ...
          <div className="grid gap-4">
            <label className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-black/35 px-4 py-3 text-sm text-zinc-100 outline-none transition placeholder:text-zinc-500 focus:border-amber-600/50"
              />
            </label>
            ...
            <label className="space-y-2">
              ...
              <div className="grid grid-cols-[142px_1fr] gap-2">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-white/10 bg-black/35 px-3 py-3 text-sm text-zinc-100 outline-none transition focus:border-amber-600/50"
                >
      ...
      <div className="mt-auto pt-6">
        <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 translate-y-10 h-32 w-3/4 bg-amber-700/20 blur-[80px]" />
        <button
          type="button"
          onClick={onNext}
          className="typo-cta group inline-flex w-full items-center justify-center gap-2 rounded-lg border border-amber-600/35 bg-gradient-to-r from-amber-800 to-orange-600 py-5 text-white transition hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(234,88,12,0.35)] active:translate-y-0"
        >
          {t("quoteContinue")}
