    ...
    <QuoteShell>
                ...
                <div className="relative">
                  <div
                    className={[
                      ...
                      selected
                        ? "border-amber-600/30 bg-black/60"
                  ...
                  >
                    ...
                    />
                    {selected ? (
                      <span className="absolute right-2 top-2 z-20 inline-flex h-6 w-6 items-center justify-center rounded-full bg-amber-700 text-white shadow-lg">
      ...
      <div className="mt-auto flex items-center justify-between gap-3 pt-6">
        ...
        <button
          ...
          className="group inline-flex items-center justify-center gap-2 rounded-lg border border-amber-600/35 bg-gradient-to-r from-amber-800 to-orange-600 px-6 py-3 text-[14px] font-bold uppercase tracking-[0.2em] text-white transition hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(234,88,12,0.35)] active:translate-y-0"
        >
          {t("quoteContinue")}
