    ...
    <QuoteShell>
            ...
            {STYLE_OPTIONS.map((option) => {
              ...
              return (
                <button
                  ...
                  className={
                    selected
                      ? "flex items-center justify-between rounded-2xl border border-amber-600/30 bg-amber-700/15 p-3"
                ...
                >
                  ...
                  <span
                    className={
                      selected
                        ? "h-2.5 w-2.5 rounded-full bg-amber-600"
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="typo-cta group inline-flex items-center justify-center gap-2 rounded-xl border border-amber-600/35 bg-gradient-to-r from-amber-800 to-orange-600 px-6 py-3 text-white transition hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(234,88,12,0.35)]"
        >
          {t("quoteContinue")}
