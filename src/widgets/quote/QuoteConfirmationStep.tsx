...
export function QuoteConfirmationStep({
  ...
  return (
    <QuoteShell>
      <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-[radial-gradient(560px_260px_at_15%_0%,rgba(251,146,60,0.26),transparent_60%),linear-gradient(180deg,rgba(255,255,255,0.05),transparent_35%),#0d0d0e] p-5 md:p-8">
      ...
      <section className="mt-5 grid gap-4 md:grid-cols-[1.15fr_.85fr]">
        <article className="glass-card rounded-2xl p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="typo-tech rounded-full border border-amber-600/35 bg-amber-700/20 px-3 py-1 text-amber-50">
              {estimate.total}
            </span>
          </div>
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-xl border border-amber-600/25 bg-amber-600/10 p-3">
              <p className="typo-tech text-amber-200/80">
                {language === "en" ? "Estimated total" : "Total estimado"}
              </p>
              <p className="typo-subtitle mt-1 text-sm text-amber-50">{estimate.total}</p>
            </div>
          </div>
        </article>
        ...
        <article className="glass-card flex items-center rounded-2xl p-5 md:sticky md:top-24 md:h-fit">
          <button
            ...
            className="typo-cta inline-flex w-full items-center justify-center gap-2 rounded-xl border border-amber-600/35 bg-gradient-to-r from-amber-800 to-orange-600 px-5 py-4 text-white transition hover:-translate-y-0.5 hover:shadow-[0_0_24px_rgba(234,88,12,0.35)] active:translate-y-0"
          >
            {t("quoteActionCta")}
          </button>
        </article>
