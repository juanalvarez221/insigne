          ...
          return (
            <button
              ...
              className={[
                ...
                spot.className,
                active
                  ? "border-amber-100/95 bg-amber-600/25 shadow-[0_0_0_1px_rgba(253,186,116,0.55)_inset,0_0_20px_rgba(251,146,60,0.4)]"
                  : "border-white/28 bg-black/10 hover:border-amber-200/70 hover:bg-amber-600/14",
              ].join(" ")}
            />
          );
        })}
    ...
    <div className="space-y-5">
          ...
          {POPULAR_ZONES.map((id) => {
            ...
            return (
              <button
                ...
                className={
                  active
                    ? "inline-flex items-center gap-2 rounded-xl border border-amber-300/45 bg-amber-600/16 px-3 py-2 text-sm font-semibold text-amber-50"
      ...
      <div className="glass-card rounded-xl p-2">
        <select
          ...
          className="w-full rounded-lg border border-white/10 bg-black/30 px-4 py-3 text-base font-semibold text-zinc-100 outline-none focus:border-amber-600/45"
        >
          {ZONES.map((item) => (
