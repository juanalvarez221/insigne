    ...
    <QuoteShell>
              ...
              <div className="flex min-h-44 items-center justify-center">
                <div className="text-center">
                  ...
                  <button
                    type="button"
                    onClick={() => inputRef.current?.click()}
                    className="mt-4 rounded-xl border border-amber-600/35 bg-amber-700/15 px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-amber-50 transition hover:bg-amber-700/20"
                  >
          ...
          <div className="mt-5 rounded-xl border border-white/10 bg-black/25 p-3">
            <label className="space-y-2">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-white/10 bg-black/35 px-4 py-3 text-sm text-zinc-100 outline-none transition placeholder:text-zinc-500 focus:border-amber-600/50"
              />
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        ...
        <Link
          ...
          className="rounded-xl border border-amber-600/35 bg-gradient-to-r from-amber-800 to-orange-600 px-6 py-3 text-sm font-bold uppercase tracking-[0.2em] text-white transition hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(234,88,12,0.35)]"
        >
