    ...
    <QuoteShell>
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="group inline-flex items-center justify-center gap-2 rounded-xl border border-amber-600/35 bg-gradient-to-r from-amber-800 to-orange-600 px-6 py-3 text-sm font-bold uppercase tracking-[0.2em] text-white transition hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(234,88,12,0.35)]"
        >
          {t("quoteContinue")}
