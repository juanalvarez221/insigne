...
const STATUS_STYLES: Record<SmartQuoteStatus, string> = {
  ...
  Enviada: "border-amber-600/30 bg-amber-700/15 text-amber-50",
          ...
          <div className="p-4 sm:p-5">
            ...
            <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-amber-600/30 bg-amber-700/15 px-3 py-2.5 text-sm font-semibold text-amber-50 transition hover:bg-amber-700/25"
              >
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-amber-600/30 bg-amber-700/15 px-3 py-2.5 text-xs font-semibold text-amber-50 transition hover:bg-amber-700/25 sm:w-auto"
                          >
